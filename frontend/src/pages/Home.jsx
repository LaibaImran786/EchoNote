...
export default function Home() {
  ...
  const handleMicTap = () => {
    ...
    if (!started) {
      setStatus("error");
      setErrorMsg(
        "Could not start the microphone. Check browser microphone permission."
      );
    }
  };
      ...
      >
        <div>
          ...
          <p style={styles.dashboardSubtitle}>
            Speak naturally. EchoNote turns your thoughts
            into searchable memories, tasks and insights.
          </p>
        </div>
        ...
        <section style={styles.recordCard}>
          ...
          <div style={styles.recordCenter}>
            ...
            <p style={styles.recordHint}>
              {status === "processing"
                ? "Gemini is finding the important pieces."
                : listening
                ? "Speak freely. Tap the button when you're finished."
                : "No script needed. Just talk like you're talking to yourself."}
            </p>
          </div>
          ...
          <div style={styles.recordFooter}>
            ...
            <span style={styles.privacyNote}>
              Your memories stay in your private memory
              space.
            </span>
          </div>
          ...
          {useManual && (
            <div style={styles.manualBox}>
              <textarea
                ...
                placeholder="Write what you would normally say out loud…"
        ...
        <aside style={styles.sideColumn}>
          ...
          <div style={styles.howCard}>
            ...
            <div style={styles.step}>
              <b>01</b>
              <span>
                Talk naturally for 30–90 seconds.
              </span>
            </div>
            ...
            <div style={styles.step}>
              <b>02</b>
              <span>
                Gemini extracts mood, people, tasks and
                topics.
              </span>
            </div>
            ...
            <div style={styles.step}>
              <b>03</b>
              <span>
                Your daily memory becomes searchable.
              </span>
            </div>
          </div>
        </aside>
      ...
      <section style={styles.recentSection}>
        ...
        {!loadingHistory && recent.length === 0 && (
          <div style={styles.emptyCard}>
            <span>✦</span>
            <p>
              Your first memory will appear here after
